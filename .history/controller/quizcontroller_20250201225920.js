...
export const attemptQuestion = async (req, res) => {
    try {
        ...
        const questionIndex = attempt.questions.findIndex(q => q.questionId.toString() === questionId);
        attempt.question[questionIndex].selectedOption = selectedOption;
        attempt.question[questionIndex].isCorrect = isCorrect;
        attempt.questions[questionIndex].marks = isCorrect ? question.marks : 0;
